...
| Hub                                      | Switch                                                                 |
| ---------------------------------------- | ---------------------------------------------------------------------- |
| Broadcast to all devices connected to it | Can only broadcast information to a specific host (Uses MAC Addresses) |
| Usually operates at half-duplex          | Can operate in half and full duplex                                    |
| Sends information using frames           | Sends information using packets                                        
## Routers
