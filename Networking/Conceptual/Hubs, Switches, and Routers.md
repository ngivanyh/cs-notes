...
| Hub                                      | Switch                                   |
| ---------------------------------------- | ---------------------------------------- |
| Broadcast to all devices connected to it | Broadcast to all devices connected to it |
| Usually operates at half-duplex          | Usually operates at half-duplex          |
| Sends information using frames           | Sends information using frames           |
## Routers
