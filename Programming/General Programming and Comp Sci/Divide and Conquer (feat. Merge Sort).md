...
This is what happens when we sort this list: `[2, 1, 3, 4]` (using the [python version](https://github.com/ngivanyh/Projects/blob/main/sorting/merge_sort/merge.py) as an example)
