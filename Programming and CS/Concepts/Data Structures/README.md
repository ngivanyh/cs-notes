...
date modified: Tuesday, July 14th 2026, 2:46:52 pm
title: README
---
# README
...
This is where the bulk of Python's extended data structures are put in. `collections` is a collection of types, while `queue`, `heapq`, and `bisect` are more specialized around a data type. Not quite comparable to C++'s [STLs](#stls) though.
